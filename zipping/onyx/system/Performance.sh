...
echo 760 760 760 765 785 795 805 825 835 865 875 900 945 1005 > /sys/devices/system/cpu/cpu0/cpufreq/UV_mV_table
...
echo 1 > /sys/devices/fdb00000.qcom,kgsl-3d0/kgsl/kgsl-3d0/min_pwrlevel